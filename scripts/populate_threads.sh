...
curl -X GET "http://localhost:3000/api/threads/populate?grade=1&term=2"
echo -e "\n"

# Grade 2
echo "Populating threads for Grade 2..."
curl -X GET "http://localhost:3000/api/threads/populate?grade=2&term=2"
echo -e "\n"

# Grade 3
echo "Populating threads for Grade 3..."
curl -X GET "http://localhost:3000/api/threads/populate?grade=3&term=2"
echo -e "\n"
